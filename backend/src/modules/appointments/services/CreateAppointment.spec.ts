...
import FakeNotificationsRepository from '@modules/notifications/repositories/fakes/FakeNotifications';
...
describe('CreateAppointment', () => {
  ...
  it('should not to be able to create an appointment before 8h or after 17h', async () => {
    jest
      .spyOn(Date, 'now')
      .mockImplementationOnce(() => new Date(2020, 4, 10, 12).getTime());
